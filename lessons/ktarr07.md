## 🏷️ Bài 7: Món hàng độc nhất
<br>
<div class="step-card border-blue">
<div class="step-badge bg-blue">Đề bài</div>

Món hàng độc nhất được định nghĩa là số chỉ xuất hiện **duy nhất 1 lần** trong dãy số. Cho dãy $A$ có $N$ số nguyên dương, số thứ $i$ trong dãy $A$ có giá trị là $a_i$ ($0 \le a_i \le 10^5$).

**Yêu cầu:** Đếm số lượng món hàng độc nhất trong dãy $A$. Tìm món hàng độc nhất **lớn nhất** và **nhỏ nhất**.
...
### Output
Ghi ra file **BAI3.OUT** gồm 3 số cách nhau khoảng trắng: số lượng độc nhất, món hàng độc nhất nhỏ nhất, món hàng độc nhất lớn nhất. Nếu không có món hàng độc nhất thì xuất `-1`.
...
Món hàng độc nhất: 0, 1, 2, 3, 5 → Tổng 5 số. Nhỏ nhất = 0, lớn nhất = 5.
...
* Món hàng độc nhất = giá trị có tần suất đúng bằng 1.
* Cần tìm min và max trong các món hàng độc nhất.
...
<span class="kw">HÀM</span> <span class="fn">SoDonDoc</span>(<span class="var">a</span>[], <span class="var">n</span>):
    ...
    <span class="com">// Bước 2: Tìm món hàng độc nhất</span>
